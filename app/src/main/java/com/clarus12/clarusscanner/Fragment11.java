...
public class Fragment11 extends Fragment implements FragmentCallback2 {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ViewGroup rootView = (ViewGroup) inflater.inflate(R.layout.fragment11, container, false);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                tv_barcode.setText("");
                tv_result.setText("해외송장을 스캔해주세요");
            }
        });
        return rootView;
    }
                ...
                if (response.isSuccessful()) {
                    ...
                    if (errMsg != null && code != null && (code.equals("INVALID_ACCESS_TOKEN") || code.equals("EXPIRE_ACCESS_TOKEN"))) {
                        if (code.equals("INVALID_ACCESS_TOKEN")) {
                            ...
                            PreferenceManager.removeKey(MainActivity.mContext, PreferenceManager.ACCESS_TOKEN);
                            Fragment11 tf = (Fragment11) ((MainActivity) MainActivity.mContext).getSupportFragmentManager().findFragmentById(R.id.container);
                            RefreshAuth.refresh(MainActivity.mContext, 11, trackingNo, tf);
                        }
                    }
                    else {
